                                    ...
                                    <div class="col-12 col-md-8 text-center">
                                        <div class="row g-4">
                                            ...
                                            <div class="pagination d-flex justify-content-center mt-5">
                                                <li class="page-item">
                                                    <a class="${1 eq currPage ? 'disabled page-link' : 'page-link'}"
                                                        href="/products?page=${currPage - 1}" aria-label="Previous">
                                                        <span aria-hidden="true">&laquo;</span>
                                                    </a>
                                                </li>
                                                <c:forEach begin="0" end="${totalPages - 1}" varStatus="loop">
                                                    <li class="page-item">
                                                        <a class="${(loop.index + 1) eq currPage ? 'active page-link' : 'page-link'}"
                                                ...
                                                <li class="page-item">
                                                    <a class="${totalPages eq currPage ? 'disabled page-link' : 'page-link'}"
                                                        href="/products?page=${currPage + 1}" aria-label="Next">
