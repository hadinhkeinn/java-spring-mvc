                                    ...
                                    <div class="container py-5">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <c:if test="${cartDetails == null || cartDetails.size() == 0}">
                                                        <tr>
                                                            <td>
                                                                <p class="mb-0 mt-2">Không có sản phảm trong giỏ hàng
                                                                </p>
                                                            </td>
                                                            <td></td>
                                                            <td></td>
                                                    ...
                                                    <c:forEach var="detail" items="${cartDetails}" varStatus="status">
